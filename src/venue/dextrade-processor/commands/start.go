...
import (
	...
	"github.com/omiga-group/omiga/src/venue/dextrade-processor/appsetup"
...
func startCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "start",
		Short: "Start dextrade-processor",
		Long:  "Start dextrade-processor",
		Run: func(cmd *cobra.Command, args []string) {
			...
			if _, err = appsetup.NewDexTradeTradingPairSubscriber(
				ctx,
				sugarLogger,
				config.DexTrade,
				cronService,
