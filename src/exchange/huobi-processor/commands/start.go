...
import (
	...
	"github.com/omiga-group/omiga/src/exchange/huobi-processor/appsetup"
...
func startCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "start",
		Short: "Start huobi-processor",
		Long:  "Start huobi-processor",
		Run: func(cmd *cobra.Command, args []string) {
			...
			if _, err = appsetup.NewHuobiTradingPairSubscriber(
				ctx,
				sugarLogger,
				config.Huobi,
				config.Exchange,
