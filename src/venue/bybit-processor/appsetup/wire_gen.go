...
func NewBybitTradingPairSubscriber(ctx context.Context, logger *zap.SugaredLogger, venueConfig configuration.BybitConfig, jobScheduler *gocron.Scheduler, postgresConfig postgres.PostgresConfig) (subscribers.BybitTradingPairSubscriber, error) {
	...
	bybitTradingPairSubscriber, err := subscribers.NewBybitTradingPairSubscriber(ctx, logger, venueConfig, jobScheduler, tradingPairRepository)
	if err != nil {
		return nil, err
	}
	return bybitTradingPairSubscriber, nil
}
