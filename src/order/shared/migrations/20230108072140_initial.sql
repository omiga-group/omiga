...
CREATE TABLE "outboxes" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 4294967296), "timestamp" timestamptz NOT NULL, "topic" character varying NOT NULL, "key" character varying NOT NULL, "payload" bytea NOT NULL, "headers" jsonb NOT NULL, "retry_count" bigint NOT NULL, "status" character varying NOT NULL, "last_retry" timestamptz NULL, "processing_errors" jsonb NULL, PRIMARY KEY ("id"));
...
-- add pk ranges for ('orders'),('outboxes') tables
INSERT INTO "ent_types" ("type") VALUES ('orders'), ('outboxes');
