...
import (
	...
	"github.com/omiga-group/omiga/src/venue/rain-processor/appsetup"
...
func startCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "start",
		Short: "Start rain-processor",
		Long:  "Start rain-processor",
		Run: func(cmd *cobra.Command, args []string) {
			...
			if _, err = appsetup.NewRainTradingPairSubscriber(
				ctx,
				sugarLogger,
				config.Rain,
				cronService,
