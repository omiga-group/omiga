...
input ExchangeWhereInput {
  ...
  hasTradingPairsWith: [TradingPairWhereInput!]
}
"""
...
func (ec *executionContext) unmarshalInputExchangeWhereInput(ctx context.Context, obj interface{}) (entities.ExchangeWhereInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "hasTradingPairsWith":
			...
			it.HasTradingPairsWith, err = ec.unmarshalOTradingPairWhereInput2ᚕᚖgithubᚗcomᚋomigaᚑgroupᚋomigaᚋsrcᚋexchangeᚋsharedᚋentitiesᚐTradingPairWhereInputᚄ(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) _TradingPair(ctx context.Context, sel ast.SelectionSet, obj *entities.TradingPair) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "base":
			...
			out.Values[i] = ec._TradingPair_base(ctx, field, obj)
		...
		case "counter":
			...
			out.Values[i] = ec._TradingPair_counter(ctx, field, obj)
