...
func NewCryptoTradingPairSubscriber(ctx context.Context, logger *zap.SugaredLogger, venueConfig configuration.CryptoConfig, cronService cron.CronService, postgresConfig postgres.PostgresConfig) (subscribers.CryptoTradingPairSubscriber, error) {
	...
	cryptoTradingPairSubscriber, err := subscribers.NewCryptoTradingPairSubscriber(ctx, logger, venueConfig, cronService, tradingPairRepository)
	if err != nil {
		return nil, err
	}
