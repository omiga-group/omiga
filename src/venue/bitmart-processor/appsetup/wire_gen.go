...
func NewBitmartTradingPairSubscriber(ctx context.Context, logger *zap.SugaredLogger, venueConfig configuration.BitmartConfig, cronService cron.CronService, postgresConfig postgres.PostgresConfig) (subscribers.BitmartTradingPairSubscriber, error) {
	...
	bitmartTradingPairSubscriber, err := subscribers.NewBitmartTradingPairSubscriber(ctx, logger, venueConfig, cronService, tradingPairRepository)
	if err != nil {
		return nil, err
	}
