...
func (r *outboxWhereInputResolver) Status(ctx context.Context, obj *repositories.OutboxWhereInput, data *models.OutboxStatus) error {
	panic(fmt.Errorf("not implemented"))
}

// StatusNeq is the resolver for the statusNEQ field.
func (r *outboxWhereInputResolver) StatusNeq(ctx context.Context, obj *repositories.OutboxWhereInput, data *models.OutboxStatus) error {
	panic(fmt.Errorf("not implemented"))
}

// StatusIn is the resolver for the statusIn field.
func (r *outboxWhereInputResolver) StatusIn(ctx context.Context, obj *repositories.OutboxWhereInput, data []models.OutboxStatus) error {
	panic(fmt.Errorf("not implemented"))
}

// StatusNotIn is the resolver for the statusNotIn field.
func (r *outboxWhereInputResolver) StatusNotIn(ctx context.Context, obj *repositories.OutboxWhereInput, data []models.OutboxStatus) error {
	panic(fmt.Errorf("not implemented"))
}
