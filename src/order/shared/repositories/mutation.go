...
// OrderBookMutation represents an operation that mutates the OrderBook nodes in the graph.
type OrderBookMutation struct {
	config
	op            Op
	typ           string
	id            *int
	...
	oldValue      func(context.Context) (*OrderBook, error)
	predicates    []predicate.OrderBook
}

var _ ent.Mutation = (*OrderBookMutation)(nil)

// orderbookOption allows management of the mutation configuration using functional options.
type orderbookOption func(*OrderBookMutation)

// newOrderBookMutation creates new mutation for the OrderBook entity.
func newOrderBookMutation(c config, op Op, opts ...orderbookOption) *OrderBookMutation {
	m := &OrderBookMutation{
		config:        c,
		op:            op,
		typ:           TypeOrderBook,
...
// withOrderBookID sets the ID field of the mutation.
func withOrderBookID(id int) orderbookOption {
	return func(m *OrderBookMutation) {
		var (
			err   error
			once  sync.Once
			value *OrderBook
		)
		m.oldValue = func(ctx context.Context) (*OrderBook, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().OrderBook.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withOrderBook sets the old OrderBook of the mutation.
func withOrderBook(node *OrderBook) orderbookOption {
	return func(m *OrderBookMutation) {
		m.oldValue = func(context.Context) (*OrderBook, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m OrderBookMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m OrderBookMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("repositories: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *OrderBookMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *OrderBookMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().OrderBook.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
func (m *OrderBookMutation) SetExchangeID(s string) {
	m.exchange_id = &s
}

// ExchangeID returns the value of the "exchange_id" field in the mutation.
func (m *OrderBookMutation) ExchangeID() (r string, exists bool) {
	v := m.exchange_id
	if v == nil {
		return
	}
...
// OldExchangeID returns the old "exchange_id" field's value of the OrderBook entity.
// If the OrderBook object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *OrderBookMutation) OldExchangeID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *OrderBookMutation) ResetExchangeID() {
	m.exchange_id = nil
}

// SetLastUpdated sets the "last_updated" field.
func (m *OrderBookMutation) SetLastUpdated(t time.Time) {
	m.last_updated = &t
}

// LastUpdated returns the value of the "last_updated" field in the mutation.
func (m *OrderBookMutation) LastUpdated() (r time.Time, exists bool) {
	v := m.last_updated
	if v == nil {
		return
	}
...
// OldLastUpdated returns the old "last_updated" field's value of the OrderBook entity.
// If the OrderBook object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *OrderBookMutation) OldLastUpdated(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *OrderBookMutation) ResetLastUpdated() {
	m.last_updated = nil
}

// SetOrderBook sets the "order_book" field.
func (m *OrderBookMutation) SetOrderBook(mb models.OrderBook) {
	m.order_book = &mb
}

// OrderBook returns the value of the "order_book" field in the mutation.
func (m *OrderBookMutation) OrderBook() (r models.OrderBook, exists bool) {
	v := m.order_book
	if v == nil {
		return
	}
...
// OldOrderBook returns the old "order_book" field's value of the OrderBook entity.
// If the OrderBook object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *OrderBookMutation) OldOrderBook(ctx context.Context) (v models.OrderBook, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldOrderBook is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldOrderBook requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldOrderBook: %w", err)
	}
	return oldValue.OrderBook, nil
}

// ResetOrderBook resets all changes to the "order_book" field.
func (m *OrderBookMutation) ResetOrderBook() {
	m.order_book = nil
}

// Where appends a list predicates to the OrderBookMutation builder.
func (m *OrderBookMutation) Where(ps ...predicate.OrderBook) {
	m.predicates = append(m.predicates, ps...)
}

// Op returns the operation name.
func (m *OrderBookMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (OrderBook).
func (m *OrderBookMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *OrderBookMutation) Fields() []string {
	fields := make([]string, 0, 3)
	if m.exchange_id != nil {
		fields = append(fields, orderbook.FieldExchangeID)
	}
	if m.last_updated != nil {
		fields = append(fields, orderbook.FieldLastUpdated)
	}
	if m.order_book != nil {
		fields = append(fields, orderbook.FieldOrderBook)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *OrderBookMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *OrderBookMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case orderbook.FieldExchangeID:
	...
	case orderbook.FieldOrderBook:
		return m.OldOrderBook(ctx)
	}
	return nil, fmt.Errorf("unknown OrderBook field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *OrderBookMutation) SetField(name string, value ent.Value) error {
	switch name {
	case orderbook.FieldExchangeID:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown OrderBook field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *OrderBookMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *OrderBookMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *OrderBookMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown OrderBook numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *OrderBookMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *OrderBookMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *OrderBookMutation) ClearField(name string) error {
	return fmt.Errorf("unknown OrderBook nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *OrderBookMutation) ResetField(name string) error {
	switch name {
	case orderbook.FieldExchangeID:
		m.ResetExchangeID()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *OrderBookMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *OrderBookMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *OrderBookMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *OrderBookMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *OrderBookMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *OrderBookMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *OrderBookMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown OrderBook unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *OrderBookMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown OrderBook edge %s", name)
}
