...
import (
	...
	configuration2 "github.com/omiga-group/omiga/src/exchange/shared/configuration"
...
func NewCryptoTradingPairSubscriber(ctx context.Context, logger *zap.SugaredLogger, cryptoConfig configuration.CryptoConfig, exchangeConfig configuration2.ExchangeConfig, cronService cron.CronService, postgresConfig postgres.PostgresConfig) (subscribers.CryptoTradingPairSubscriber, error) {
	...
	cryptoTradingPairSubscriber, err := subscribers.NewCryptoTradingPairSubscriber(ctx, logger, cryptoConfig, exchangeConfig, cronService, tradingPairRepository)
	if err != nil {
		return nil, err
	}
	return cryptoTradingPairSubscriber, nil
}
