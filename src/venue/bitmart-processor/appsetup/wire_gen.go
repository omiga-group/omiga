...
func NewBitmartTradingPairSubscriber(ctx context.Context, logger *zap.SugaredLogger, venueConfig configuration.BitmartConfig, jobScheduler *gocron.Scheduler, postgresConfig postgres.PostgresConfig) (subscribers.BitmartTradingPairSubscriber, error) {
	...
	bitmartTradingPairSubscriber, err := subscribers.NewBitmartTradingPairSubscriber(ctx, logger, venueConfig, jobScheduler, tradingPairRepository)
	if err != nil {
		return nil, err
	}
