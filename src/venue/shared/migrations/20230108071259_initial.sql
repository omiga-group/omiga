...
CREATE TABLE "outboxes" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 8589934592), "timestamp" timestamptz NOT NULL, "topic" character varying NOT NULL, "key" character varying NOT NULL, "payload" bytea NOT NULL, "headers" jsonb NOT NULL, "retry_count" bigint NOT NULL, "status" character varying NOT NULL, "last_retry" timestamptz NULL, "processing_errors" jsonb NULL, PRIMARY KEY ("id"));
...
CREATE TABLE "markets" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 4294967296), "name" character varying NOT NULL, "type" character varying NOT NULL, "venue_market" bigint NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "markets_venues_market" FOREIGN KEY ("venue_market") REFERENCES "venues" ("id") ON DELETE CASCADE);
...
-- add pk ranges for ('currencies'),('markets'),('outboxes'),('tickers'),('trading_pairs'),('venues') tables
INSERT INTO "ent_types" ("type") VALUES ('currencies'), ('markets'), ('outboxes'), ('tickers'), ('trading_pairs'), ('venues');
