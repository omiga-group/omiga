...
import (
	...
	"github.com/omiga-group/omiga/src/venue/bybit-processor/appsetup"
...
func startCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "start",
		Short: "Start bybit-processor",
		Long:  "Start bybit-processor",
		Run: func(cmd *cobra.Command, args []string) {
			...
			if _, err = appsetup.NewBybitTradingPairSubscriber(
				ctx,
				sugarLogger,
				config.Bybit,
				jobScheduler,
