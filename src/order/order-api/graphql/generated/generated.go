...
func (ec *executionContext) unmarshalInputCurrencyInput(ctx context.Context, obj interface{}) (models.CurrencyInput, error) {
	...
	fieldsInOrder := [...]string{"code", "name", "maxPrecision", "digital"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputQuantityInput(ctx context.Context, obj interface{}) (models.QuantityInput, error) {
	var it models.QuantityInput
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}

	fieldsInOrder := [...]string{"amount", "scale"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalNQuantityInput2ᚖgithubᚗcomᚋomigaᚑgroupᚋomigaᚋsrcᚋorderᚋorderᚑapiᚋgraphqlᚋmodelsᚐQuantityInput(ctx context.Context, v interface{}) (*models.QuantityInput, error) {
