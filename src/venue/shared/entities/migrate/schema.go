...
var (
	...
	MarketsColumns = []*schema.Column{
		...
		{Name: "type", Type: field.TypeEnum, Enums: []string{"SPORT_TRADING", "MARGIN_TRADING", "DERIVATIVES", "EARN", "PERPETUAL", "FUTURES", "WARRANT", "OTC", "YIELD", "P2P", "STRATEGY_TRADING", "SWAP_FARMING", "FAN_TOKEN", "ETF", "NFT", "SWAP", "LIQUIDITY"}},
