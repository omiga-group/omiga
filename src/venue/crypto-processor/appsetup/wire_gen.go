...
func NewCryptoTradingPairSubscriber(ctx context.Context, logger *zap.SugaredLogger, venueConfig configuration.CryptoConfig, jobScheduler *gocron.Scheduler, postgresConfig postgres.PostgresConfig) (subscribers.CryptoTradingPairSubscriber, error) {
	...
	cryptoTradingPairSubscriber, err := subscribers.NewCryptoTradingPairSubscriber(ctx, logger, venueConfig, jobScheduler, tradingPairRepository)
	if err != nil {
		return nil, err
	}
