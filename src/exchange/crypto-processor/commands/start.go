...
import (
	...
	"github.com/omiga-group/omiga/src/exchange/crypto-processor/appsetup"
...
func startCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "start",
		Short: "Start crypto-processor",
		Long:  "Start crypto-processor",
		Run: func(cmd *cobra.Command, args []string) {
			...
			if _, err = appsetup.NewCryptoTradingPairSubscriber(
				ctx,
				sugarLogger,
				config.Crypto,
				config.Exchange,
