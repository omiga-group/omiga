...
// GetSymbolDetailsData defines model for getSymbolDetailsData.
type GetSymbolDetailsData struct {
	Symbols              []Symbol               `json:"symbols"`
	AdditionalProperties map[string]interface{} `json:"-"`
}

// GetSymbolDetailsResponse defines model for getSymbolDetailsResponse.
type GetSymbolDetailsResponse struct {
	Code                 int                    `json:"code"`
	Data                 GetSymbolDetailsData   `json:"data"`
...
// Getter for additional properties for GetSymbolDetailsData. Returns the specified
// element and whether it was found
func (a GetSymbolDetailsData) Get(fieldName string) (value interface{}, found bool) {
...
// Setter for additional properties for GetSymbolDetailsData
func (a *GetSymbolDetailsData) Set(fieldName string, value interface{}) {
	if a.AdditionalProperties == nil {
...
// Override default JSON handling for GetSymbolDetailsData to handle AdditionalProperties
func (a *GetSymbolDetailsData) UnmarshalJSON(b []byte) error {
...
// Override default JSON handling for GetSymbolDetailsData to handle AdditionalProperties
func (a GetSymbolDetailsData) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
// Getter for additional properties for GetSymbolDetailsResponse. Returns the specified
// element and whether it was found
func (a GetSymbolDetailsResponse) Get(fieldName string) (value interface{}, found bool) {
	if a.AdditionalProperties != nil {
		value, found = a.AdditionalProperties[fieldName]
	}
	return
...
// Setter for additional properties for GetSymbolDetailsResponse
func (a *GetSymbolDetailsResponse) Set(fieldName string, value interface{}) {
	if a.AdditionalProperties == nil {
		a.AdditionalProperties = make(map[string]interface{})
	}
	a.AdditionalProperties[fieldName] = value
...
// Override default JSON handling for GetSymbolDetailsResponse to handle AdditionalProperties
func (a *GetSymbolDetailsResponse) UnmarshalJSON(b []byte) error {
	object := make(map[string]json.RawMessage)
	err := json.Unmarshal(b, &object)
	if err != nil {
		return err
...
// Override default JSON handling for GetSymbolDetailsResponse to handle AdditionalProperties
func (a GetSymbolDetailsResponse) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
type ClientInterface interface {
	// GetAllSymbolDetails request
	GetAllSymbolDetails(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) GetAllSymbolDetails(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetAllSymbolDetailsRequest(c.Server)
	if err != nil {
		return nil, err
	}
...
// NewGetAllSymbolDetailsRequest generates requests for GetAllSymbolDetails
func NewGetAllSymbolDetailsRequest(server string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	// GetAllSymbolDetails request
	GetAllSymbolDetailsWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetAllSymbolDetailsResponse, error)
}

type GetAllSymbolDetailsResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *GetSymbolDetailsResponse
}

// Status returns HTTPResponse.Status
func (r GetAllSymbolDetailsResponse) Status() string {
...
func (r GetAllSymbolDetailsResponse) StatusCode() int {
	if r.HTTPResponse != nil {
...
// GetAllSymbolDetailsWithResponse request returning *GetAllSymbolDetailsResponse
func (c *ClientWithResponses) GetAllSymbolDetailsWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetAllSymbolDetailsResponse, error) {
	rsp, err := c.GetAllSymbolDetails(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetAllSymbolDetailsResponse(rsp)
}

// ParseGetAllSymbolDetailsResponse parses an HTTP response from a GetAllSymbolDetailsWithResponse call
func ParseGetAllSymbolDetailsResponse(rsp *http.Response) (*GetAllSymbolDetailsResponse, error) {
	...
	response := &GetAllSymbolDetailsResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest GetSymbolDetailsResponse
