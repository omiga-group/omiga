...
func NewMexcTradingPairSubscriber(ctx context.Context, logger *zap.SugaredLogger, venueConfig configuration.MexcConfig, jobScheduler *gocron.Scheduler, postgresConfig postgres.PostgresConfig) (subscribers.MexcTradingPairSubscriber, error) {
	...
	mexcTradingPairSubscriber, err := subscribers.NewMexcTradingPairSubscriber(ctx, logger, venueConfig, jobScheduler, tradingPairRepository)
	if err != nil {
		return nil, err
	}
	return mexcTradingPairSubscriber, nil
}
