...
type GetMarketConfigResponse struct {
	AdditionalProperties map[string]MarketConfig `json:"-"`
}
...
// Getter for additional properties for GetMarketConfigResponse. Returns the specified
// element and whether it was found
func (a GetMarketConfigResponse) Get(fieldName string) (value MarketConfig, found bool) {
...
// Setter for additional properties for GetMarketConfigResponse
func (a *GetMarketConfigResponse) Set(fieldName string, value MarketConfig) {
	if a.AdditionalProperties == nil {
		a.AdditionalProperties = make(map[string]MarketConfig)
	}
	a.AdditionalProperties[fieldName] = value
}

// Override default JSON handling for GetMarketConfigResponse to handle AdditionalProperties
func (a *GetMarketConfigResponse) UnmarshalJSON(b []byte) error {
...
// Override default JSON handling for GetMarketConfigResponse to handle AdditionalProperties
func (a GetMarketConfigResponse) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
