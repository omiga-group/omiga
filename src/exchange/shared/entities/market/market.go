...
func TypeValidator(_type Type) error {
	switch _type {
	case TypeSPORT_TRADING, TypeMARGIN_TRADING, TypeDERIVATIVES, TypeEARN, TypePERPETUAL, TypeFUTURES, TypeWARRANT, TypeOTC, TypeYIELD, TypeP2P, TypeSTRATEGY_TRADING, TypeSWAP_FARMING, TypeFAN_TOKEN, TypeETF, TypeNFT, TypeSwap:
		return nil
	default:
