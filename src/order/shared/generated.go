...
func (ec *executionContext) _OrderPayload_clientMutationId(ctx context.Context, field graphql.CollectedField, obj *OrderPayload) (ret graphql.Marshaler) {
...
func (ec *executionContext) _OrderPayload_order(ctx context.Context, field graphql.CollectedField, obj *OrderPayload) (ret graphql.Marshaler) {
...
func (ec *executionContext) unmarshalInputExchangeInput(ctx context.Context, obj interface{}) (ExchangeInput, error) {
	var it ExchangeInput
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}
...
func (ec *executionContext) _OrderPayload(ctx context.Context, sel ast.SelectionSet, obj *OrderPayload) graphql.Marshaler {
...
func (ec *executionContext) marshalOOrderPayload2ᚖgithubᚗcomᚋomigaᚑgroupᚋomigaᚋsrcᚋorderᚋsharedᚐOrderPayload(ctx context.Context, sel ast.SelectionSet, v *OrderPayload) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
