...
func NewKucoinTradingPairSubscriber(ctx context.Context, logger *zap.SugaredLogger, venueConfig configuration.KucoinConfig, jobScheduler *gocron.Scheduler, postgresConfig postgres.PostgresConfig) (subscribers.KucoinTradingPairSubscriber, error) {
	...
	kucoinTradingPairSubscriber, err := subscribers.NewKucoinTradingPairSubscriber(ctx, logger, venueConfig, jobScheduler, tradingPairRepository)
	if err != nil {
		return nil, err
	}
