...
const (
	// Label holds the string label denoting the tradingpairs type in the database.
	Label = "trading_pairs"
	...
	// Table holds the table name of the tradingpairs in the database.
	Table = "trading_pairs"
...
// Columns holds all SQL columns for tradingpairs fields.
var Columns = []string{
	FieldID,
	FieldSymbol,
	FieldBase,
